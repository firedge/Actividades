 ...
 */
public class ActividadRest implements Serializable{
    private String id, idprofesor, tipo, fechai, fechaf, lugari, lugarf, descripcion, alumno;

    public ActividadRest(String id, String idprofesor, String tipo, String fechai, String fechaf, String lugari, String lugarf, String descripcion, String alumno) {
        this.id = id;
    ...
    public ActividadRest(ActividadComplementaria object) {
            this.idprofesor = object.getProfesores();
            this.tipo = "complementaria";
            this.fechai = object.getFecha()+" "+object.getHoraentrada();
            this.fechaf = object.getFecha()+" "+object.getHorasalida();
            this.lugari = object.getLugar();
            this.lugarf = object.getLugar();
            this.descripcion = object.getDescripcion();
            this.alumno = "gamarra";
    }

    public ActividadRest(ActividadExtraescolar object) {
        this.idprofesor = object.getProfesores();
        this.tipo = "extraescolar";
        this.fechai = object.getFechasalida()+" "+object.getHorasalida();
        this.fechaf = object.getFechallegada()+" "+object.getHorallegada();
        this.lugari = object.getLugarsalida();
        this.lugarf = object.getLugarllegada();
        this.descripcion = object.getDescripcion();
        this.alumno = "gamarra";
    }
